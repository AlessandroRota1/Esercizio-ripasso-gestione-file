...
namespace Esercizio_ripasso_gestione_file
{
    internal class Program
    {
            ...
            do                  //ciclo do while che verifica se ripetere il programma o chiuderlo
            {
                ...
                switch (Console.ReadLine())         //switch che verifica l'input ricevuto
                {
                    ...
                    case "u":
                        ...
                        break;
                    case "f":
                        StreamReader aa = new StreamReader("file.txt");
        ...
        static string[] file(string[] array)
        {
